                                                ...
                                                <div class="mt-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 d-none">
                                                            <div class="form-group">
                                                                <label>{{ translate('address_type')}} {{("(Optional)")}}</label>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label>{{ translate('country')}} {{("(Optional)")}}</label>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label>{{ translate('city')}} {{("(Optional)")}}</label>
...
@push('script')
    ...
    function saveCheckoutDraft() {
        ...
        draftTimer = setTimeout(function () {
            ...
            const phone = $('#shipping_phone_view').val().trim();
            ...
            $.ajax({
                url: "{{ route('checkout.draft.store') }}",
                method: "POST",
                data: {
                    name: name,
                    email: email,
    ...
    const inputs = ['#name', '#email', '#shipping_phone_view', '#address'];
    inputs.forEach(function(selector) {
        if ($(selector).length) {
            $(document).on("input", selector, saveCheckoutDraft);
        }
    });
</script>
