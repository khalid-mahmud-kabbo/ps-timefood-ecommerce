<form action="{{ route('cart.add') }}" method="POST" id="OpenedModal">
    @csrf
    ...
    <div class="d-flex justify-content-center mt-4">
        <button type="submit" class="btn text-white web--bg-primary" id="submitButton">
...
<script>
    function submitBuyNowForm() {
        const form = document.getElementById('OpenedModal');

        // Remove modal trigger class or data (if any)
