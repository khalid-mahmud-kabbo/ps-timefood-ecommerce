...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{ $direction}}"
    ...
    <body>
        ...
        <div class="first content-position" style="width:595px;margin: 0 auto;">
            ...
            <div style="width:520px;margin: 0 auto;background-color: #F2F4F7;padding: 11px 19px 10px 32px;">
                <table class="fz-10">
                    <tr>
                        <td>
                            <span>{{ url('/') }}</span>
                        ...
                        <td>
                            <span>{{ getWebConfig('company_phone') }}</span>
                        </td>
                        <td>
                            <span>{{ getWebConfig('company_email') }}</span>
                        </td>
                    </tr>
                </table>
            </div>
             ...
             <table style="margin-top:6rem;">
                <tr>
                        <td colspan="5" class="border-bottom" style="border-width: 0.5rem;"></td>
                    </tr>
