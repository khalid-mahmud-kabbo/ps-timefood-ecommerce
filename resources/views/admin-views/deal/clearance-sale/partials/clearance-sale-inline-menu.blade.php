...
<div class="position-relative nav--tab-wrapper mb-4">
    <ul class="nav nav-pills nav--tab" id="pills-tab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link {{ Request::is('admin/deal/clearance-sale/' . ClearanceSale::VENDOR_OFFERS[URI]) ? 'active' : '' }}"
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link {{ Request::is('admin/deal/clearance-sale/' . ClearanceSale::PRIORITY_SETUP[URI]) ? 'active' : '' }}"
