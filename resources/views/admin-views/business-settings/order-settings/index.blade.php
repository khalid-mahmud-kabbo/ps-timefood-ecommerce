                    ...
                    <div class="p-12 p-sm-20 bg-section rounded">
                        <div class="row g-4">
                            ...
                            <div class="col-xl-6 col-md-6">
                             ...
                             @php($shippingMethodStatus = getWebConfig('shipping_method_status'))
                            <div class="col-xl-6 col-md-6">
                                <label
                                    class="d-flex justify-content-between align-items-start gap-3 border rounded p-3 user-select-none h-100 bg-white">
                                    <span>
                                        <h5 class="fw-medium text-dark fs-14 mb-1">{{ translate('customer_Shipping_Method_Choose') }}</h5>
                                        <p class="mb-0 fs-12">
                                            {{ translate('if_enabled_this_option_customers_can_choose_the_delivery_option_on_order') }}.
                                        </p>
                                    </span>
                                    <label class="switcher" for="shipping-method-status">
                                        <input
                                            class="switcher_input custom-modal-plugin"
                                            type="checkbox" value="1" name="shipping_method_status"
                                            id="shipping-method-status"
                                            {{ $shippingMethodStatus == 1 ? 'checked' : '' }}
                                            data-modal-type="input-change"
                                            data-on-image="{{ dynamicAsset(path: 'public/assets/new/back-end/img/modal/guest-checkout-on.png') }}"
                                            data-off-image="{{ dynamicAsset(path: 'public/assets/new/back-end/img/modal/guest-checkout-off.png') }}"
                                            data-on-title="{{ translate('by_Turning_ON_customer_Shipping_Method_Choose_Mode') }}"
                                            data-off-title="{{ translate('by_Turning_Off_customer_Shipping_Method_Choose_Mode') }}"
                                            data-on-message="<p>{{ translate('customers_can_choose_the_delivery_option_on_order') }}</p>"
                                            data-off-message="<p>{{ translate('customers_cannot_choose_the_delivery_option_on_order') }}</p>">
                                        <span class="switcher_control"></span>
                                    </label>
