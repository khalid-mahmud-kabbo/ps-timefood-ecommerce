...
<div class="position-relative nav--tab-wrapper mb-4">
    <ul class="nav nav-pills nav--tab" id="pills-tab" role="tablist">
        <li class="nav-item">
            <a class="nav-link {{ Request::is('admin/pages-and-media/vendor-registration-settings/'.VendorRegistrationSetting::INDEX[URI]) ?'active':'' }}"
                href="{{ route('admin.pages-and-media.vendor-registration-settings.index') }}">{{translate('header')}}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ Request::is('admin/pages-and-media/vendor-registration-settings/'.VendorRegistrationSetting::WITH_US[URI]) ?'active':'' }}"
                href="{{ route('admin.pages-and-media.vendor-registration-settings.with-us') }}">{{translate('why_Sell_With_Us')}}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ Request::is('admin/pages-and-media/vendor-registration-settings/'.VendorRegistrationSetting::BUSINESS_PROCESS[URI]) ?'active':'' }}"
                href="{{ route('admin.pages-and-media.vendor-registration-settings.business-process') }}">{{translate('business_Process')}}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ Request::is('admin/pages-and-media/vendor-registration-settings/'.VendorRegistrationSetting::DOWNLOAD_APP[URI]) ?'active':'' }}"
                href="{{ route('admin.pages-and-media.vendor-registration-settings.download-app') }}">{{translate('download_App')}}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ Request::is('admin/pages-and-media/vendor-registration-settings/'.VendorRegistrationSetting::FAQ[URI]) ?'active':'' }}"
